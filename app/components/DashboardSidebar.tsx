      ...
      <nav className="flex-1 px-3 pt-5 pb-3 space-y-1.5 overflow-y-auto">
        ...
        <div className="pt-3">
          ...
          <Link
            href="/privacy"
            target="_blank"
            className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all group text-text-tertiary hover:text-text-primary hover:bg-bg-tertiary/60 ${isCollapsed ? "justify-center" : ""}`}
            title={isCollapsed ? "Privacy Policy" : undefined}
          >
            <div className="flex items-center justify-center w-8 h-8 rounded-lg transition bg-bg-tertiary/80 group-hover:bg-border-secondary/80 shrink-0">
              <svg
                className="w-4 h-4"
                fill="none"
                viewBox="0 0 24 24"
