/**
 * Route-level Loading Template
 *
 * This template is used by the AI to generate loading.tsx files
 * for Next.js applications. Works with both Client and Server Components.
 */
