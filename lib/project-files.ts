...
export interface ReactProjectForFiles {
  files: GeneratedFile[];
  dependencies: Record<string, string>;
}

export interface ProjectFilesMap {
  [path: string]: string;
}

export function hasAuthentication(project: ReactProjectForFiles): boolean {
...
export function prepareProjectFiles(
  ...
  if (aiPkgFile) {
    try {
      ...
      // Keep defaults if package parsing fails.
    }
  }
...
This app was generated by Danphe.
